        ...
        <table class="table align-items-center justify-content-center mb-0">
          ...
          <tr>
            ...
            <th class="text-center">
              <router-link to="/logistic/product/add"><img src="@/assets/img/add.png" style="width: 30px; height: 30px"
                                                           alt="Add"></router-link>
            </th>
          </tr>
          </thead>
...
export default {
  ...
  methods: {
    ...
    edit(id) {
      router.push({path: '/logistic/product/' + id});
    }
  },
  created() {
    this.getDrobilkas()
