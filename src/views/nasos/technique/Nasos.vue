        ...
        <table class="table align-items-center justify-content-center mb-0">
          ...
          <tr>
            ...
            <th class="text-center">
              <router-link to="/nasos/add"><img src="@/assets/img/add.png" style="width: 30px; height: 30px" alt="Add"></router-link>
            </th>
          </tr>
          </thead>
          <tbody>
          <tr v-for="(t,index) in techniques" :id="index" v-bind:key="index">
            ...
            <td>
              <div class="d-flex">
                <div>
                  <img
                      src="@/assets/img/icons/crane.png"
                      class="m-2"
                      width="35"
                      height="35"
                      alt="spotify"
